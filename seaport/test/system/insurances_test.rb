...
class InsurancesTest < ApplicationSystemTestCase
  ...
  test "creating a Insurance" do
    ...
    fill_in "Cargo", with: @insurance.cargo
    fill_in "Company", with: @insurance.company_id
    fill_in "Insurance number", with: @insurance.insurance_number
    fill_in "Insurance type", with: @insurance.insurance_type
    fill_in "Premium", with: @insurance.premium
