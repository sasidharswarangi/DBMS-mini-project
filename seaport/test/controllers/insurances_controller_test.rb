...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { cargo: @insurance.cargo, company_id: @insurance.company_id, insurance_number: @insurance.insurance_number, insurance_type: @insurance.insurance_type, premium: @insurance.premium } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { cargo: @insurance.cargo, company_id: @insurance.company_id, insurance_number: @insurance.insurance_number, insurance_type: @insurance.insurance_type, premium: @insurance.premium } }
