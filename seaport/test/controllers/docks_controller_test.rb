...
class DocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dock" do
    assert_difference('Dock.count') do
      post docks_url, params: { dock: { dock_number: @dock.dock_number, occupied: @dock.occupied, size: @dock.size } }
    end
  ...
  test "should update dock" do
    patch dock_url(@dock), params: { dock: { dock_number: @dock.dock_number, occupied: @dock.occupied, size: @dock.size } }
